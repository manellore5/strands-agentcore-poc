...
**Status:** ✅ Delivered (live deployment in AWS)
...
- The agent is **live** in AWS and reachable via the AWS SDK, with autonomous multi-tool routing (calculator + real-time weather).
...
| Why-Strands / why-AgentCore explainer | ✅ | This document |
